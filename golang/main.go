// Author: Gary Ascuy
// Example: go run main.go --image assets/orange.png
...
func Predict(bounds image.Rectangle, img image.Image) {
  ...
  fmt.Println("\n{ RED , YELLOW } = {", red, ",", yellow, "}, Mean =", redMean)
  if redMean > 0.5 {
    fmt.Println("Predict: It is an 'Strawberry'")
  } else {
    fmt.Println("Predict: It is an 'Orange'")
  }
}
